		...
		<div class='itemBox le <?php echo ($key % 2 ? 'itemEven' : 'itemOdd');?>'>
			<div class='p-10 splitmegrd'>
				<div class='itemBoxinfo'>
					<h4><a href='<?php echo site_url($this->ln.'/'. $controller .'/show/'. $item->id); ?>'><?php echo $item->title; ?></a></h4>
					<?php 
				...
				<div class='le'>
					<div class="average_rate rate_spl" data-average="<?php echo $item->average_rate; ?>" data-id="<?php echo $item->id;?>" data-module="<?php echo $controller;?>"></div>
				</div>
