    ...
    <b-modal class="ex-add-dxf-modal"
        ...
        <div class="container position-relative">
            <b-row style="margin-top: 60px">
                <b-col class="col-xl-12">
                    ...
                    <div class="ex-uploaded-file-details" v-show="uploadedFile.name">
                        <v-menu bottom left class="ex-thumbnail-actions-dropdown" content-class="ex-dxf-file-dropdown-three-dots">
                            <v-btn icon slot="activator" dark>
                                <v-icon>more_vert</v-icon>
                            </v-btn>
                            <v-list>
                                <v-list-tile @click="triggerDropzone">
                                    <v-list-tile-title>{{ $tc('scenario_wizard.dxf.file_options', 1) }}</v-list-tile-title>
                                </v-list-tile>
                                <v-list-tile class="ex-dropdown-divider" @click="$refs.myVueDropzone.removeAllFiles()">
                                    <v-list-tile-title class="ex-delete" >{{ $tc('scenario_wizard.dxf.file_options', 2) }}</v-list-tile-title>
                                </v-list-tile>
                            </v-list>
                        </v-menu>
            ...
            <template v-if="uploadedFile.name">
                            ...
                            <div class="ex-assign-levels position-relative"
                                ...
                                <ul class="ex-coincidence-check mb-4">
                                    <li>
                                        ...
                                        <label :for="'option_single_level' + index">{{ $t('scenario_wizard.dxf.single_level') }}</label>
                                        <div class="check"/>
                                    </li>
                                    <li>
                                        <input type="radio"
                                        ...
                                        <label :for="'option_range_level' + index">{{ $t('scenario_wizard.dxf.range_level') }}</label>
                                        <div class="check"/>
                                    </li>
                                </ul>
                                ...
                                <div v-if="assignedLevel.singleRangeLevel === 2">
                                    <div style="display: inline-block" class="mr-3">
                                        ...
                                        <div class="ex-unit-select mb-4">
                                            <v-select :items="rangeFilteredLevelItems(levelItems[groundType - 1], index)"
                                ...
                                <ul class="ex-coincidence-check mb-4">
                                    <li class="mb-3">
                                        ...
                                        <label for="option_spec_under1">
                                            {{ groundType == 1 ? $t('scenario_wizard.dxf.completely_aboveground') : $t('scenario_wizard.dxf.completely_underground') }}
                                        </label>
                                        <div class="check"/>
                                    </li>
                                    <li>
                                        ...
                                        <label for="option_spec_above1">
                                            {{ groundType == 1 ? $t('scenario_wizard.dxf.partly_aboveground') : $t('scenario_wizard.dxf.partly_underground') }}
                                        </label>
                                        <div class="check"/>
                                    </li>
                                </ul>
                ...
                <b-row>
                    <div class="col">
                        <p class="ex-assign-level-title">{{ $t('scenario_wizard.dxf.specify_layer_names', {level: 1}) }}</p>
                ...
                <b-row>
                    <div class="col">
                        ...
                        <h5 class="ex-step-used-subtitle mb-3">{{ $t('scenario_wizard.dxf.dimension_details_sub') }}</h5>
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <label class="ex-unit-select-label">{{ $t('scenario_wizard.dxf.ceiling_height') }}</label>
                                <input type="number" min="0" class="ex-input-floor-roof" v-model="dimensionDetails.ceilingHeight.value">
                                <div class="ex-unit-select">
                                    <v-select :items="unitItems"
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="number" min="0" class="ex-input-floor-roof" v-model="dimensionDetails.doorHeight.value">
                                <div class="ex-unit-select">
                                    <v-select :items="unitItems"
                            ...
                            <div class="col-lg-3">
                                <label class="ex-unit-select-label">{{ $t('scenario_wizard.dxf.window_height') }}</label>
                                <input type="number" min="0" class="ex-input-floor-roof" v-model="dimensionDetails.windowHeight.value">
                                <div class="ex-unit-select">
                                    <v-select :items="unitItems"
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-3">
                                <label class="ex-unit-select-label">{{ $t('scenario_wizard.dxf.window_sill_height') }}</label>
                                <input type="number" min="0" class="ex-input-floor-roof" v-model="dimensionDetails.windowSillHeight.value">
                                <div class="ex-unit-select">
                                    <v-select :items="unitItems"
            ...
            <b-row>
                <div class="col text-right">
                    <button type="button" @click="addDxfFile" class="ex-main-btn" :class="{ 'ex-main-disabled-btn': checkValidation() }">{{ $t('global.save') }}</button>
                </div>
            </b-row>
        </div>
    </b-modal>
